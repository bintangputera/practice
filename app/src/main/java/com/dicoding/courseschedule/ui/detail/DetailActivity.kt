...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            findViewById<TextView>(R.id.tv_course_name).text = this.courseName
            findViewById<TextView>(R.id.tv_lecturer).text = this.lecturer
            findViewById<TextView>(R.id.tv_note).text = this.note
